// Netlify Function — proxy seguro para a API da Groq (gratuita).
// A chave fica só aqui no servidor (variável de ambiente GROQ_API_KEY),
// nunca é exposta no front-end.
...
exports.handler = async function (event) {
  ...
  try {
    const res = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        // Llama 3.3 70B: bom equilíbrio entre qualidade e velocidade na Groq (grátis).
